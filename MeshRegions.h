...
public:
    ...
    int defineBoundary(void* edgeFun, int N, int bndID, int Ncurve = 2, double AoA = 0., int direction = 1, void* mapFun = nullptr);
    ...
    int omeshBoundaryMapping(std::string filename, std::vector<double> center,double radius);
private:
